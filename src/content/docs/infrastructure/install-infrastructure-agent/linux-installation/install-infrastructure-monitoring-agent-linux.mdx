...
6. Install the `newrelic-infra` package in root (default), privileged user, or unprivileged user mode. For more information on each running mode, see [Linux agent running modes](/docs/infrastructure/install-configure-infrastructure/linux-installation/linux-agent-running-modes).
   ...
   <CollapserGroup>
     <Collapser
       ...
       title="Root (default)"
     >
       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="Debian.png" alt="Debian.png" src={debian}/> Debian and <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="ubuntu icon" alt="ubuntu icon" src={ubuntuIcon}/> Ubuntu**:

         ```
         sudo apt-get install newrelic-infra -y
         ```
       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="amazon linux.png" alt="amazon linux.png" src={amazonLinux}/> Amazon Linux, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="centos icon" alt="centos icon" src={centosIcon}/> CentOS, <img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="redhat icon" alt="redhat icon" src={redHatNew2}/> RHEL**:

         ```
         sudo yum install newrelic-infra -y
         ```
       * **<img style={{ width: '32px', height: '32px', verticalAlign: 'middle'}} class="inline" title="suse icon" alt="suse icon" src={suseIcon}/> SLES**:
